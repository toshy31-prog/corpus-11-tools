...
test("list exposes fixture aliases and their provenance", () => {
  ...
  assert.match(output, /^ilyana\tinternal_synthetic\t/m);
  assert.match(output, /^braess\tmixed\t/m);
});
...
test("unknown fixtures have no executable fallback", () => {
