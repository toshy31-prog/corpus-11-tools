...
import { createCheapest, createLowestAxis, createPublicMaximin } from "../confrontation-1.2/contenders.mjs";
...
const report = {
  ...
  campaign: "CCT-KRYOS-CONFRONTATION-1.2-002",
  ...
  projectionContract: "CCT-KRYOS-PROJECTION-002",
