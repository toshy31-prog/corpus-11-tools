# État réel du paquet CCT-EXEC-0.1

| Composant | Décrit | Écrit | Testé localement | Autorisé | Déployé | Réobservé |
|---|---:|---:|---:|---:|---:|---:|
| Constitution exécutable | oui | oui | oui | non | non | non |
| Économie multi-modèles | oui | oui | oui, synthétique | sans objet | non | non |
...
La présence de fichiers et le passage des tests ne donnent aucune autorité publique. Toute promotion de colonne exige une trace nouvelle et une autorité compétente extérieure au paquet.
