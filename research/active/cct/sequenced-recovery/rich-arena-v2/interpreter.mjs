...
function applyRound(document, world, bundleId, round, exogenous) {
  ...
  world.trace.push({ round, event: actions.length ? "applied_bundle" : "forced_no_action", bundleId: canonicalBundleId, before, after: clone(world.state), delayed: clone(world.delayed), reversalFlags: clone(world.reversalFlags) });
}
