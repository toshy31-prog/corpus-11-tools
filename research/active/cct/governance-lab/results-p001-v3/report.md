# Résultats P001-DT-003

## Verdict

**bounded_continuity_cell_survives_synthetic_twin**
...
- **base** — amélioration du besoin non servi : 19.8 % ; ratio face au meilleur rival : 1.00 ; ratio de retour sûr face au centre : 1.00 ; gain droits : 9.6 ; gain restitution : 2.8 ; échec : non.
- **dense_shocks** — amélioration du besoin non servi : 19.5 % ; ratio face au meilleur rival : 1.00 ; ratio de retour sûr face au centre : 1.00 ; gain droits : 15.2 ; gain restitution : 2.8 ; échec : non.
- **long_supply** — amélioration du besoin non servi : 18.1 % ; ratio face au meilleur rival : 1.02 ; ratio de retour sûr face au centre : 1.00 ; gain droits : 13.6 ; gain restitution : 2.8 ; échec : non.
- **hostile_to_gate** — amélioration du besoin non servi : 5.4 % ; ratio face au meilleur rival : 1.15 ; ratio de retour sûr face au centre : 1.10 ; gain droits : 10.9 ; gain restitution : 2.1 ; échec : oui.
