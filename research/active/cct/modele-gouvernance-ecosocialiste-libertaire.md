...
```mermaid
flowchart TB
    P["Personnes et communautés de vie"]
    L["Communes / quartiers"]
    B["Biorégions et bassins de vie"]
    R["Fédérations régionales"]
    C["Confédération planétaire"]
    K["Communs fonctionnels trans-territoriaux"]
    J["Garanties indépendantes : droits, science, audit, justice"]
    ...
    R <--> K
    C <--> K
    J -. contrôle et recours .-> L
    J -. contrôle et recours .-> B
    J -. contrôle et recours .-> R
    J -. contrôle et recours .-> C
    P -. saisine directe .-> J
```
