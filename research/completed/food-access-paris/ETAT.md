...
> **Nature de l’objet : cycle de recherche terminé.** Le site a été techniquement déployé avec un accès privé au propriétaire, sans test utilisateur extérieur ni effet alimentaire attribuable. Les mentions historiques d’« intervention » ne valent pas preuve d’une action de terrain.
...
- cycle expérimental 001 ouvert sous le nom historique « intervention 001 » ;
